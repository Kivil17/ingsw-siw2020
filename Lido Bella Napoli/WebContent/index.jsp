...
<body>
				...
				<div class="row no-gutters">
					...
					<div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
						<div class="count-box">
							...
							<p>
								<strong>Happy Clients</strong> all our satisfied clients
							</p>
						</div>
					</div>
              ...
              <p><strong>Projects</strong> adipisci atque cum quia aut</p>
					...
					<div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
						<div class="count-box">
							...
							<p>
								<strong>Hours Of Support</strong> all our collaborator at your
								support
							</p>
						</div>
					</div>
					...
					<div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
						<div class="count-box">
							<i class="icofont-users-alt-5"></i> <span
								data-toggle="counter-up">1500</span>
							<p>
								<strong>Users online</strong> number users online at now
							</p>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6">
						<div class="member" data-aos="fade-up">
							<div class="pic">
								<img src="assets/img/team/ciccio.png" class="img-fluid" alt="">
							</div>
							<div class="member-info">
								<h4>Francesco Trotta</h4>
								<span>Master of Pizza</span>
								<div class="social">
									<a href=""><i class="icofont-facebook"></i></a> <a href=""><i
					...
					<div class="col-lg-4 col-md-6">
						<div class="member" data-aos="fade-up" data-aos-delay="150">
							<div class="pic">
								<img src="assets/img/team/io.png" class="img-fluid" alt="">
							</div>
							<div class="member-info">
					...
					<div class="col-lg-4 col-md-6">
						<div class="member" data-aos="fade-up" data-aos-delay="300">
							<div class="pic">
								<img src="assets/img/team/ugiur.jpeg" class="img-fluid" alt="">
							</div>
							<div class="member-info">
					...
					<div class="col-lg-4 col-md-6">
						<div class="member" data-aos="fade-up" data-aos-delay="300">
							<div class="pic">
								<img src="assets/img/team/artembitch.jpeg" class="img-fluid" alt="">
							</div>
							<div class="member-info">
								<h4>Artem Savka</h4>
								<span>Lifeguard</span>
					...
					<div class="col-lg-4 col-md-6">
						<div class="member" data-aos="fade-up" data-aos-delay="300">
							<div class="pic">
								<img src="assets/img/team/scarlett.jpg" class="img-fluid" alt="">
							</div>
							<div class="member-info">
					...
					<div class="col-lg-4 col-md-6">
						<div class="member" data-aos="fade-up" data-aos-delay="300">
							<div class="pic">
								<img src="assets/img/team/emmaStone.jpg" class="img-fluid"
									alt="">
							</div>
							<div class="member-info">
								<h4>Emma Stone</h4>
				...
				<div class="row" data-aos="fade-up" data-aos-delay="200">
					...
					<div class="col-lg-6 ">
						<iframe class="mb-4 mb-lg-0"
							src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3073.477084282835!2d16.635944015331138!3d39.61646057946615!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x13409b65ae124733%3A0xd5b0bd02f9a4220f!2sBella%20Napoli%20Rossano!5e0!3m2!1sit!2sit!4v1610381651060!5m2!1sit!2sit"
	...
	<!-- End #main -->
	<!-- da chiamare servlet recensione -->
	<!-- ======= Footer ======= -->
	<footer id="footer">
		...
		<div class="container">
			<div class="copyright">
				&copy; Copyright <strong><span>Bella Napoli</span></strong>. All
				Rights Reserved
			</div>
		</div>
	</footer>
