(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "BellaNapoli-"; // Prefix string to be prepended to the cart's name in the session storage
			...
			this.paypalBusinessEmail = "bellanapoli1987@outlook.it"; // Your Business PayPal's account email address
