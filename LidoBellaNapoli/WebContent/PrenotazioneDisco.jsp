...
<body>
	...
	<section id="hero">
		<div class="hero-container" data-aos="fade-up">
			<h1>BOOK OUR TABLE</h1>
			<h2>BOOK NOW YOUR FAVOURITE TABLE</h2>
		</div>
	...
	<main id="main">
		<h1></h1>
		<section id="info-w">
			<div id="numeroPersone-w">
				Persone: <span id="numeroPersone">2</span>
						...
						<div class="stars">
							<form action="AddReview" method="get">
								...
								<label class="star star-5" for="star-5-2"></label> <input
									...
									<input type="hidden" name="pagina" id="pagina" value="PrenotazioneDisco"/>
								<div class="rev-box">
	...
	<script src="assets/js/prenotazioneDisco.js"></script>
